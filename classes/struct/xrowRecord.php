...
class xrowRecord implements ezcBasePersistable, ezcSearchDefinitionProvider
{
    ...
    function __construct( $installation_id = false, $language = 'ger-DE', $meta_guid = null, $meta_name = null, $meta_main_url_alias = null, $meta_description_text = null,$meta_image_url=null, $keywords = null )
    {
        if ( $meta_guid === null )
        {
    ...
    static public function getDefinition()
    {
        ...
        $n->fields['meta_image_url'] = new ezcSearchDefinitionDocumentField( 'meta_image_url', xrowSOLRHandler::MS );
        $n->fields['meta_description_text'] = new ezcSearchDefinitionDocumentField( 'meta_description_text', ezcSearchDocumentDefinition::TEXT, 1, false, false, true );
        return $n;
    }
    ...
    function getState()
    {
        $state = array( 
            ...
            'meta_description_text' => $this->meta_description_text 
        );
        return $state;
    }
